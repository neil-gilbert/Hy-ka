    ...
    def generate(self, task_input: str, model_config: dict) -> ProviderResult:
        ...
        try:
            client = OpenAI(
                ...
                base_url=model_config.get("base_url") or self._base_url,
            )
            ...
            completion = client.chat.completions.create(
                ...
                extra_headers={
                    "HTTP-Referer": str(model_config.get("http_referer", "https://modeleval.local")),
                    "X-Title": str(model_config.get("x_title", "ModelEval")),
                },
            )
